...
/*
 * This class is based on the Spring ProviderManager and is used for debugging.
 * Later on we should be able to replace it with the original class.
 */

/**
 * Iterates an {@link org.springframework.security.core.Authentication} request through a list of {@link org.springframework.security.authentication.AuthenticationProvider}s.
 *
 * <p>
 ...
 * <p>
 * The exception to this process is when a provider throws an {@link org.springframework.security.authentication.AccountStatusException}, in which case no
 ...
 * implements the {@link org.springframework.security.core.CredentialsContainer} interface. This behaviour can be controlled by modifying the
 * {@link #setEraseCredentialsAfterAuthentication(boolean) eraseCredentialsAfterAuthentication} property.
 *
 * <h2>Event Publishing</h2>
 * <p>
 * Authentication event publishing is delegated to the configured {@link org.springframework.security.authentication.AuthenticationEventPublisher} which defaults
 * to a null implementation which doesn't publish events, so if you are configuring the bean yourself you must inject
 * a publisher bean if you want to receive events. The standard implementation is {@link org.springframework.security.authentication.DefaultAuthenticationEventPublisher}
...
public class ProviderManager extends org.springframework.security.authentication.ProviderManager implements MessageSourceAware, InitializingBean {
    ...
    /**
     * Attempts to authenticate the passed {@link org.springframework.security.core.Authentication} object.
     * <p>
